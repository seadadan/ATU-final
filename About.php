		...
		<div class="container">
			<div class="row showcase-section">
				<div class="image-container col-sm-6 col-xs-12 pull-left">
					<img src="plugins/home-plugins/img/service1.jpg" alt="showcase image">
				</div>
					...
					<div class="about-text">
						...
						<p>Shaqo doon is the place for jobseekers to find the job of their dreams and 
						 ...
						 <p>Shaqo Raadis was founded August 2021. The main objectives of maintining this 
							 blog is to have a comprehensive and easily accessible platform for job seekers.
							 We are connecting employeers and job seekers in the region.</p>
					</div>
				</div>
			</div>
		</div>
